...
(function () {
    ...
    app.constant('$API_NAME', {
        ...
        SetBankMessage:'user.addbank',
        SubmitMemberMessage:'user.addgroup',
    });
    ...
    app.factory('SystemService',function ($http,$API_NAME,$CODE_MESSAGE) {
        ...
        systemService.setBankMessage = function (params) {
            params.api = $API_NAME.SetBankMessage;
            requestUrl =  baseUrl +'api='+$API_NAME.SetBankMessage;
            return requestHttp(requestUrl,params);
        }

        systemService.submitMemberMessage = function (params) {
            params.api = $API_NAME.SubmitMemberMessage;
            requestUrl =  baseUrl +'api='+$API_NAME.SubmitMemberMessage;
            return requestHttp(requestUrl,params);
        }
